...
public class AdvancementsRecipeRenderer implements PlaceRecipe<Ingredient> {
    ...
    private static final ResourceLocation GUI_TEXTURE_CRAFTING_TABLE = ResourceLocation.withDefaultNamespace(
            "textures/gui/container/crafting_table.png");
    private static final ResourceLocation GUI_TEXTURE_FURNACE = ResourceLocation.withDefaultNamespace(
            "textures/gui/container/furnace.png");
    private static final ResourceLocation GUI_TEXTURE_BLAST_FURNACE = ResourceLocation.withDefaultNamespace(
            "textures/gui/container/blast_furnace.png");
    private static final ResourceLocation GUI_TEXTURE_SMOKER = ResourceLocation.withDefaultNamespace(
            "textures/gui/container/smoker.png");
    private static final ResourceLocation GUI_TEXTURE_SMITHING = ResourceLocation.withDefaultNamespace(
            "textures/gui/container/smithing.png");
    private static final ResourceLocation GUI_TEXTURE_ANVIL = ResourceLocation.withDefaultNamespace("textures/gui/container/anvil.png");
    ...
    static void setGhostRecipe(ItemStack icon) {
        ...
        getInstance().setGhostRecipe(ResourceLocation.parse(icon.get(DataComponents.CUSTOM_DATA).copyTag().getString("Crafting")));
    }
