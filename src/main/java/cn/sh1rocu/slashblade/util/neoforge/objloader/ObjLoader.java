...
package cn.sh1rocu.slashblade.util.neoforge.objloader;

import cn.sh1rocu.slashblade.util.neoforge.objloader.model.StandardModelParameters;
import cn.sh1rocu.slashblade.util.neoforge.objloader.model.obj.ObjGeometry;
 ...
 */
public class ObjLoader implements UnbakedModelDeserializer, ResourceManagerReloadListener {
    public static ObjLoader INSTANCE = new ObjLoader();

    public static final Identifier ID = SlashBlade.prefix("obj_loader");
    ...
    @Override
    public UnbakedModel deserialize(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
